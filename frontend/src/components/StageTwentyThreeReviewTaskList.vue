...
<style scoped>
.health-review-panel { display:grid; gap:18px; min-width:0; color:#18312d; }.panel-header { display:flex; align-items:flex-start; justify-content:space-between; gap:24px; }.panel-header>view { display:grid; gap:7px; }.eyebrow { color:#23877d; font-size:12px; font-weight:700; }.title { font-size:24px; font-weight:700; }.subtitle { color:#6f817d; font-size:13px; }.panel-header button,.filters button,.pagination button { margin:0; border:1px solid #cad9d6; border-radius:6px; background:#fff; color:#385752; font-size:13px; }
