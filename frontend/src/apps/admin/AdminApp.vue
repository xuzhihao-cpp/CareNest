...
<template>
  <view class="admin-app">
    ...
    <main class="admin-main">
      <view class="admin-top"><view><text class="eyebrow">OPERATIONS</text><text class="page-title">{{ visibleNav.find((item) => item.key === view)?.label }}</text></view><text class="today">今日运营中心</text></view>
