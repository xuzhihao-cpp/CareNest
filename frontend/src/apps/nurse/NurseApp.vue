...
<template>
  <view class="nurse-app">
    ...
    <main
      class="shell-main"
      :class="{
        'with-work-overview': primaryView === 'tasks' && activeTab === 'tasks',
        'with-section-nav': primaryView === 'records' || primaryView === 'account'
      }"
    >
...
.nurse-app{--nurse-header-height:92px;overflow-x:clip}
.nurse-app .shell-header{position:fixed;top:0;right:0;left:0;z-index:40;min-height:var(--nurse-header-height);box-sizing:border-box;background:rgba(255,255,255,.97)}
.nurse-app .shell-main{padding-top:calc(var(--nurse-header-height) + 18px)}
.nurse-app .shell-main.with-work-overview{padding-top:calc(var(--nurse-header-height) + 186px)}
.nurse-app .shell-main.with-section-nav{padding-top:calc(var(--nurse-header-height) + 84px)}
.nurse-app .work-overview,.nurse-app .section-nav{position:fixed;right:0;left:0;z-index:25;background:#f4f6f3;box-shadow:0 8px 12px -14px rgba(31,52,41,.45);box-sizing:border-box}
.nurse-app .work-overview{top:var(--nurse-header-height);padding:14px 16px 18px}
