...
import type { AiConversationMessage, AiMessageResponse, AiSession, AiSessionPage, AiSpeechTranscriptionResponse, AssistanceTicketItem, CustomerServiceTicket, CustomerServiceTicketDetail, TicketMessage } from '@/types/stageFortyOne'
...
export const transcribeAiSpeech=(filePath:string,fileName:string,elderId?:string,blob?:Blob)=>uploadMultipart<AiSpeechTranscriptionResponse>({url:'/ai/speech/transcriptions',filePath,fileName,blob,formData:elderId?{elderId}:{}})
