...
import type { AiConversationMessage, AiMessageResponse, AiSession, AiSessionPage, AssistanceTicketItem, CustomerServiceTicket, CustomerServiceTicketDetail, TicketMessage } from '@/types/stageFortyOne'
