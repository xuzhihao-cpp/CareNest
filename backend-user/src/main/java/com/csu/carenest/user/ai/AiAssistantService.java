...
public class AiAssistantService {
    ...
    @Transactional public AiAssistantDtos.MessageResult message(String token,String sessionId,AiAssistantDtos.MessageRequest req){
        ...
        AiProvider.Result result=provider.answer(req.content()); String trace="trace_"+UUID.randomUUID().toString().replace("-",""); String userMsg="msg_"+UUID.randomUUID().toString().replace("-",""); String aiMsg="msg_"+UUID.randomUUID().toString().replace("-","");
